...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "Executed JMeter performance benchmarks simulating up to 5,000 virtual users and identified 2 critical response-time bottlenecks before production release.",
    ],
    techStack: [
      "Java",
      "Selenium",
