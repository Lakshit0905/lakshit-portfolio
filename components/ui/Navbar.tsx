    ...
    <>
      <motion.header
        ...
        className={cn(
          ...
          scrolled
            ? "nav-blur border-b border-white/[0.06] bg-[#0a0b12]/85 shadow-[0_1px_0_0_rgba(99,102,241,0.08)]"
            : "bg-transparent"
        )}
      >
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            {siteConfig.resumeUrl && (
              <a
                ...
                download
                className="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition-all duration-200 hover:bg-indigo-500 hover:shadow-[0_0_20px_rgba(99,102,241,0.35)] active:scale-95"
              >
                <Download size={14} />
                Resume
              </a>
